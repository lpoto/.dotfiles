...
hl.diagnostics = {
  ...
  LspDiagnosticsUnderlineError = { undercurl = true, fg = colors.error },
  LspDiagnosticsUnderlineWarning = { undercurl = true, fg = colors.warning },
  LspDiagnosticsUnderlineInformation = { undercurl = true, fg = colors.info },
  LspDiagnosticsUnderlineHint = { undercurl = true, fg = colors.hint },
